...
\begin{abstract}
In this work, we introduce a tool for live programming in general purpose code editors.
The live programming paradigm gives programmers realtime feedback when writing code,
traditionally via a graphical user interface.
To implement our live coding environment, we extend a fully-featured IDE with the ability to show input/output examples of code execution,
...
Our goal is to use live programming to give novice programmers a new way to interact and understand programming,
  as well as being a useful development tool for even more advanced programmers.
