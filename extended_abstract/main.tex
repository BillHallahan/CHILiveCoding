...
traditionally via a graphical user interface. Despite live programming's practical values, such as providing an easier overview of code and better understanding of its structure, live programming is still not widely used by everyday programmers.
In this work, we propose to extend the live programming paradigm to general purpose code editors, which will allow that 
live programming can be finally  used by programmers and practitioners who need to get a better understanding of what the given code is doing, and how to easily change it.
To achieve that we extended a traditional code editor with the ability to show input/output examples of code execution,
...
We believe that using live programming can help novice programmers better understand the structure and the behavior of given code.
